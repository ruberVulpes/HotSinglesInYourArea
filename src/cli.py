...
@click.option(
    "-s",
    "--start-year",
    type=valid_year_range,
    help="The year to start collecting songs from",
)
@click.option(
    "-e",
    "--end-year",
    type=valid_year_range,
    help="The year to end collecting songs from",
)
@click.option(
    "--limit",
    type=click.IntRange(min=1),
    default=300,
    help="The number of songs to use for the playlist",
)
